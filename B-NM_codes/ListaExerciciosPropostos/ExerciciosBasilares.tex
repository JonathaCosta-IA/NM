...
de $5 Hz$ (5 vezes por segundo). Os dados no intervalo $4 \le t \le 8$ s são dados a seguir.
\[
\begin{aligned}
...
\begin{itemize}
    \item Produza um $novoY$ a partir da reta gerada.
    \item Calcule o erro quadrático total.
    \item Encontro o valor de y para um $ \delta\ | \ \delta\ \subset  \ x$.
    \item Trace o gráfico com: $ x \times y , x \times novoY$. 
\end{itemize}

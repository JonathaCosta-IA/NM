...
em \href{https://github.com/JonathaCosta-IA/NM/blob/main/B-NM_codes/SolListaExerciciosPropostos/z_AplicMN_eng/dados.csv}{Vetor}} de medições de temperatura(°C) a seguir.
\[

...
simulação e avaliação do desempenho dos algoritmos. 
\end{abstract}
...
\begin{itemize}
	...
	\item Seção \ref{sec:SolSistNaoLineares} - utilização de MNs para solução de sistemas de equações não lineares;
...
\begin{itemize}
    \item Compreender o modelo matemático antes de programar;
    \item Utilizar o código como ferramenta, não como ponto de partida;
    \item Validar casos simples manualmente;
    \item Analisar erro de truncamento, estabilidade e custo computacional;
    \item Implementar soluções modulares, documentadas e reprodutíveis;
    \item Comparar com soluções analíticas ou referências confiáveis;
    \item Interpretar os resultados no contexto físico e de engenharia.
\end{itemize}

\clearpage
% =================================================================================
Para fins de consulta e modelagem basilar, soluções alternativas estão disponíveis no repositório do professor pelo endereço: \url{https://github.com/JonathaCosta-IA/NM/tree/main/B-NM_codes}.
\input{textual/ExerciciosBasilares}
\input{textual/ExerciciosIntegradosProjetos.tex}
